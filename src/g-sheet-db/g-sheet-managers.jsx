...
export default function FetchCSVDataMan() {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQV_JuIAtLHYEmi1jQSzwYEmYFlf_4r0V6n7YdQaIeEfgaRJEV4NznSWizPnGpJggYauRb8EoS-eUTW/pub?gid=175777516&single=true&output=csv'; // Replace with your Google Sheets CSV file URL
    ...
    return csvData.map(man=> {
      return(
      <>
        <p>{man.Id_num}-{man.Full_name}-{man.Team}</p>
      </>
    )}
    )
}